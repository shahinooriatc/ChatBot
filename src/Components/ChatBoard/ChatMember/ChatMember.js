  ...
  render() {
    ...
    return (
      ...
      >
        ...
        <div
          className="groups"
          style={{ backgroundColor: "#2bccf6", marginTop: "25px" }}
        >
          <BsPeopleFill
          ...
          <h4>
            Groups <>({this.state.group.length})</>
          ...
          >
            {this.state.group.map((item,index) => (
              <Button key={index}
                ...
                onClick={() => this.handleChangeGroup(item)}
              >
                <BsGlobe style={{ marginRight: "10px" }} />
                {item.groupName}
              </Button>
            ))}
          </ListGroup>
        ...
        <div
          className="friend"
          style={{ backgroundColor: "#5fffff", marginTop: "50px" }}
        >
          <h4>Friends</h4>
          <input
            type="text"
          ...
          <ListGroup
            className="overflow-auto"
            style={{ textAlign: "left", height: "150px" }}
          >
